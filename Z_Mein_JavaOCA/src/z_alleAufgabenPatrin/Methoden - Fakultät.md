...
> Hinweis: ignorieren Sie bei der Lösung der Aufgabe den möglichen int-Bereich-Überlauf (bereits bei 13!). Überlegen Sie, ob es möglich ist, die Lösung so zu definieren, dass die Methoden immer korrekt sind ohne dabei die Methodendeklarationen zu ändern
