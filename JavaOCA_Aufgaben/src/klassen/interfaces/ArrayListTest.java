...
public class ArrayListTest {
	...
	public static void main(String[] args) {
		...
		// auch moeglich, gleiches Ergebnis: ArrayList<String> stringListe = new ArrayList<>();
...
//		Collections.sort(stringListe); // vor Java 8
		...
		//Sortierung absteigend
		System.out.println("+++++++++++");
		stringListe.sort(new MyComparatorFeuersteins());
		for (String name : stringListe) {
			System.out.println(name);
		}
		
		// oder schneller und ohne die Extradatei
		System.out.println("+++++++++++");
		stringListe.sort(Comparator.reverseOrder());
		for (String name : stringListe) {
			System.out.println(name);
		}
