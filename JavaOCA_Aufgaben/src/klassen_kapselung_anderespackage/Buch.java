package klassen_kapselung_anderespackage;

import java.time.LocalDate;

// Kapselung (encapsulation): Variablen des Objekts werden gesch�tzt, Zugrifff von au�en nur �ber wohldefinierte Methoden
...
//	public int test = 42;
	...
	public void setIsbn(String isbn) {
		if (isbn.length() != 13) {
			throw new IllegalArgumentException("ISBN muss die L�nge 13 haben: " + isbn);
		}
	...
	public void setErscheinungsjahr(int erscheinungsjahr) {
		if (erscheinungsjahr < MIN_ERSCHEINUNGSJAHR || erscheinungsjahr > LocalDate.now().getYear()) {
			throw new IllegalArgumentException("Ung�tliges Erscheinungsjahr: " + erscheinungsjahr);
		}
	...
	public String toString() {
	 ...
	 public int compareTo (Buch buch) {
		 return this.autor.compareTo(buch.autor);
		 }
